---
name: reverse-ai-product-suite
description: Run a complete evidence-based reverse-engineering suite on an AI or creative product using screenshots, browser-visible pages, chats, canvas assets, task states, model choices, previews, and errors. Use when the user wants the same four-deliverable teardown workflow: user journey, multi-Agent I/O contracts, one functional-equivalent Agent System Prompt, and full product architecture, each as a standalone HTML file.
---
...
- `../reverse-user-journey/SKILL.md` and its directly referenced report contract.
- `../reverse-agent-contracts/SKILL.md` and its directly referenced report contract.
- `../reconstruct-agent-prompt/SKILL.md` and its directly referenced report contract.
- `../reverse-product-architecture/SKILL.md` and its directly referenced report contract.
...
- Apply `$reverse-user-journey` methodology.
...
- Apply `$reverse-agent-contracts` methodology.
...
- Apply `$reconstruct-agent-prompt` methodology.
...
- Apply `$reverse-product-architecture` methodology.
